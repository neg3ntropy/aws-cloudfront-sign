...
function getSignedUrl(cfUrl, params) {
  ...
  parsedUrl.search = '';
  parsedUrl.query['Expires'] = policy.expireTime;
  parsedUrl.query['Policy'] = normalizeBase64(policyStr);
  parsedUrl.query['Signature'] = normalizeBase64(signature);
  parsedUrl.query['Key-Pair-Id'] = params.keypairId;
